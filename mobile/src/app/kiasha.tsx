...
function PaperPerformance({ portfolio, colors }: { portfolio: PaperPortfolio | null; colors: ThemeColors }) {
  ...
  return <View style={[styles.paperCard, { backgroundColor: colors.backgroundElement }]}>
    ...
    {portfolio && !portfolio.paperExecutionEnabled && !portfolio.demo ? <Text style={[styles.paperDisabled, { color: colors.textSecondary }]}>اجرای خودکار Paper فعلاً خاموش است؛ موجودی و تحلیل قابل مشاهده‌اند.</Text> : null}
