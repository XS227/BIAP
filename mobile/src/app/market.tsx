...
type ScanMode = '' | 'live' | 'cached' | 'catalog';
...
export default function MarketScreen() {
  ...
  const modeColor = scanMode === 'live' ? Brand.positive : scanMode === 'cached' || scanMode === 'catalog' ? Brand.warning : colors.textSecondary;
