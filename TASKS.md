...
3. Expo device test: verify Real Trade card appears on stock detail for a normal/non-demo account, shows Farabi selected plus completed/pending readiness checklist, and exposes no real order action.
