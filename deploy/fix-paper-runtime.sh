...
KIASHA_AI_TIMEOUT_SECONDS=12
KIASHA_AI_MAX_ROUNDS=3
...
sudo sh -c "tr '\\0' '\\n' < /proc/$PID/environ | grep -E '^(KIASHA_PAPER_EXECUTION_ENABLED|KIASHA_AUTO_INVEST_RUNNER_ENABLED|KIASHA_PAPER_MIN_CONFIDENCE|KIASHA_AI_TIMEOUT_SECONDS|KIASHA_AI_MAX_ROUNDS|BIAP_TSETMC_API_BASE|BIAP_TSETMC_RELAY_BASE|LIVE_TRADING_ENABLED)='"
printf '\ntimer: '
