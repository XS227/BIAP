    ...
    <div class="wrap">
      <div style="border:1px solid #315ecf;background:linear-gradient(135deg,rgba(31,73,166,.30),rgba(16,23,37,.97));border-radius:18px;padding:20px;display:flex;gap:18px;align-items:center;justify-content:space-between;flex-wrap:wrap;box-shadow:0 18px 60px rgba(0,0,0,.20)">
        <div style="min-width:240px;flex:1">
          ...
          <div style="margin-top:9px;color:#8291aa;font-size:10px">BIAP Global 0.3.8 · Android Universal · about 101 MB</div>
        </div>
...
'''
    ...
    text = text.replace("BIAP Global 0.3.5 · Android ARM64 · about 45 MB", "BIAP Global 0.3.8 · Android Universal · about 101 MB")
    text = text.replace("BIAP Global 0.3.6 · Android Universal · about 101 MB", "BIAP Global 0.3.8 · Android Universal · about 101 MB")
    path.write_text(text, encoding="utf-8")
PY
else
...
server {
    ...
    location ^~ /download/ {
        ...
        add_header Content-Disposition "attachment; filename=BIAP-Global-0.3.8-universal.apk" always;
