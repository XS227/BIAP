...
SOURCE_PLANS: dict[str, dict] = {
    ...
    "CH": {"market": "SIX / global market feed", "filings": "issuer annual reports + SEC 20-F IFRS for exact cross-listed issuers", "status": "partial", "notes": "Nestlé (NESN) issuer-published 2025 consolidated IFRS statements and Novartis (NOVN/NVS) official SEC 20-F CompanyFacts are production-verified. Other SIX issuers remain blocked until a verified primary filing source is connected."},
