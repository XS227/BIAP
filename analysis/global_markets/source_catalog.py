...
SOURCE_PLANS: dict[str, dict] = {
    ...
    "CA": {"market": "TMX universe / global market feed", "filings": "SEC 40-F IFRS / cross-listed 10-K US-GAAP CompanyFacts + SEDAR+ planned", "status": "partial", "notes": "Exact Canadian issuer identities with SEC annual filings are connected through official CompanyFacts: 40-F IFRS and cross-listed 10-K US-GAAP are supported with strict legal-name verification. Other TSX/TSXV issuers remain blocked until a verified SEDAR+ or issuer filing source is connected."},
    ...
    "CH": {"market": "SIX / global market feed", "filings": "issuer annual reports + SEC 20-F IFRS for exact cross-listed issuers", "status": "partial", "notes": "Nestlé (NESN) issuer-published 2025 statements plus current Novartis (NOVN/NVS) and Alcon (ALC) SEC 20-F CompanyFacts are production-verified. Foreign SEC annual periods older than 550 days are rejected; unsupported or stale SIX issuers remain blocked."},
    ...
    "NZ": {"market": "NZX / global market feed", "filings": "NZX issuer disclosures", "status": "partial", "notes": "NZX Limited (NZX), Summerset (SUM) and Scales (SCL) audited 2025 annual reports are production-verified through the official NZX announcement service with PDF provenance and primary-statement parsing. Other NZX issuers remain blocked until separately verified."},
    ...
    "AE": {"market": "official ADX/DFM exchange feeds", "filings": "ADX issuer-filed annual financial reports + DFM Efsah annual statements", "status": "connected", "notes": "DFM Efsah annual statements and ADX efid issuer-filed annual Financial Reports are connected. ADX verifies the official PDF and cross-checks overlapping headline metrics against its structured annual summary."},
    ...
    "ZA": {"market": "JSE / global market feed", "filings": "SEC 20-F IFRS CompanyFacts + JSE SENS/issuer reports planned", "status": "partial", "notes": "Exact JSE issuer identities that also file audited IFRS annual 20-F data with the SEC can use official CompanyFacts with strict legal-name verification. Other JSE issuers remain blocked until a verified JSE SENS or issuer filing source is connected."},
