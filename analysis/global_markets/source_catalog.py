...
SOURCE_PLANS: dict[str, dict] = {
    ...
    "AE": {"market": "ADX/DFM / global market feed", "filings": "ADX structured summary + DFM Efsah annual statements", "status": "partial", "notes": "DFM Efsah issuer-filed yearly financial-statement PDFs are connected and parsed conservatively from the primary statements. ADX structured annual summary is also connected for net profit, equity, EPS and P/B, but ADX remains partial because revenue, assets/liabilities and cash flow are not present in that endpoint."},
