...
SOURCE_PLANS: dict[str, dict] = {
    ...
    "NZ": {"market": "NZX / global market feed", "filings": "NZX issuer disclosures", "status": "partial", "notes": "NZX Limited (NZX) audited 2025 annual report is connected through the official NZX announcement service with verified PDF provenance and primary-statement parsing. Other NZX issuers remain blocked until separately verified."},
